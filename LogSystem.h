...
/// The log system only stores the year with two digits. Setting
/// the base year will automatically do the right conversion.
///
/// E.g. you set the year to 2015 and the system has stored 07,
/// it will convert this into 2107.
///
/// Be aware, the DateTime type from the RTClib has additional
/// limitations for the handling of the year.
///
...
public:
    ...
    ///
    inline int8_t getTemperature() const { return _temperature; }
    
    /// Get the humidity of the record in percent 0-100.
    ///
    inline int8_t getHumidity() const { return _humidity; }
